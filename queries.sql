...
SELECT SUM(total) FROM invoices WHERE billing_country = "USA" AND billing_state = "CA";

-- The number of invoices and the invoice total from California
SELECT COUNT(*), SUM(total) FROM invoices WHERE billing_country = "USA" AND billing_state = "CA";

-- The count, total, and average of invoice totals from California
SELECT COUNT(*), SUM(total), AVG(total) FROM invoices WHERE billing_country = "USA" AND billing_state = "CA";
